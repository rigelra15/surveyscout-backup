...
void main() {
  runApp(Clientsurveyorproyekdetailperingatan());
}

class Clientsurveyorproyekdetailperingatan extends StatelessWidget {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        Icons.warning_rounded, // Ganti dengan ikon sesuai kebutuhan
                        color: Colors.white,
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text(
                                '10.00 WIB, Kamis, 20 Februari 2025 (2 hari yang lalu)',
                                style: TextStyle(
                                  fontSize: 10,
                                  fontWeight: FontWeight.w400,
                                  fontFamily: "NunitoSans",
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Icon(Icons.thumb_up, color: Color(0xFFA3948D), size: 10),
                                      SizedBox(width: 4),
                                      Text(
                                        '90%',
                                        style: TextStyle(
                ...
                SizedBox(height: 10),
                Text(
                  'Surveyor akan mewawancarai pengguna transportasi umum seperti TransJakarta, KRL, dan MRT untuk mengetahui tingkat kepuasan mereka terhadap layanan yang diberikan. Data akan digunakan oleh Dinas Perhubungan untuk meningkatkan layanan.',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
                ...
                SizedBox(height: 10),
                Text(
                  'Tenaga surveyor harus Mampu melakukan wawancara dengan ramah dan profesional. Mengerti cara mencatat jawaban dengan cepat. Familiar dengan formulir Google Form atau kuesioner digital lainnya.',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
                ...
                SizedBox(height: 10),
                Text(
                  'Rekap jawaban responden dalam format PDF dan Excel. Rekaman wawancara (opsional, jika diizinkan responden).',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
