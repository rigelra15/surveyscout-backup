...
class Surveyorproyekdetailmendaftar extends StatefulWidget {
  final String id;

  const Surveyorproyekdetailmendaftar({Key? key, required this.id})
      : super(key: key);

  @override
  _SurveyorproyekdetailmendaftarState createState() =>
      _SurveyorproyekdetailmendaftarState();
}

class _SurveyorproyekdetailmendaftarState
    extends State<Surveyorproyekdetailmendaftar> {
