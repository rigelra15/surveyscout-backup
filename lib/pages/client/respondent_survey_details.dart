...
class _RespondentSurveyDetailsScreenState
  ...
  final TextEditingController _projectLocationController =
      TextEditingController();
  final TextEditingController _projectRegistrationDeadlineController =
      TextEditingController();
  final TextEditingController _projectCompletionDeadlineController =
      TextEditingController();
  ...
  bool _isFormComplete() {
    return _projectTitleController.text.isNotEmpty &&
        ...
        _projectRegistrationDeadlineController.text.isNotEmpty &&
        _projectCompletionDeadlineController.text.isNotEmpty;
  }
  ...
  void _clearFormData() {
    ...
    box.remove('project_registration_deadline');
    box.remove('project_completion_deadline');
    ...
    setState(() {
      ...
      _projectRegistrationDeadlineController.clear();
      _projectCompletionDeadlineController.clear();
    });
  ...
  void initState() {
    ...
    _projectRegistrationDeadlineController.text =
        GetStorage().read('project_registration_deadline') ?? '';
    _projectCompletionDeadlineController.text =
        GetStorage().read('project_completion_deadline') ?? '';
    ...
    _projectRegistrationDeadlineController.text =
        GetStorage().read('project_registration_deadline') ?? formattedDeadline;

    // Set initial text with formatted deadline
    _projectCompletionDeadlineController.text =
        GetStorage().read('project_completion_deadline') ?? formattedDeadline;
  }
  ...
  void dispose() {
    ...
    _projectRegistrationDeadlineController.dispose();
    super.dispose();
  }
  ...
  void _saveProjectRegistrationDeadline(String value) {
    GetStorage().write('project_registration_deadline', value);
  }

  void _saveProjectCompletionDeadline(String value) {
    GetStorage().write('project_completion_deadline', value);
  }
  ...
  void _saveDraft() {
    ...
    _saveProjectRegistrationDeadline(
        _projectRegistrationDeadlineController.text);
    _saveProjectCompletionDeadline(_projectCompletionDeadlineController.text);
  }
  ...
  Future<void> _selectRegistrationDate(BuildContext context) async {
    ...
    if (pickedDate != null) {
      ...
      if (pickedTime != null) {
        ...
        setState(() {
          _projectRegistrationDeadlineController.text = formattedDate;
          _saveProjectRegistrationDeadline(formattedDate);
        });
      }
    }
  }
  ...
  Future<void> _selectCompletionDate(BuildContext context) async {
    ...
    if (pickedDate != null) {
      ...
      if (pickedTime != null) {
        ...
        // Update the controller with the formatted text
        setState(() {
          _projectCompletionDeadlineController.text = formattedDate;
          _saveProjectCompletionDeadline(formattedDate);
        });
      }
    }
  }
        ...
        child: ListView(
          children: [
            ...
            _buildDateTimeField(
              ...
              controller: _projectRegistrationDeadlineController,
              hintText: "Pilih tenggat waktu pendaftaran",
            ...
            _buildDateTimeField(
              ...
              controller: _projectCompletionDeadlineController,
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  RespondentCriteriaDetailsScreen(
                                    ...
                                    method:
                                        _projectQualificationController.text,
                                    task: _projectOutcomeController.text,
                                    commission:
                                        _projectCommissionController.text,
                                    respondentAmount:
                                        _projectRespondentAmountController.text,
                                    ...
                                    registrationDeadline:
                                        _projectRegistrationDeadlineController
                                            .text,
                                    completionDeadline:
                                        _projectCompletionDeadlineController
                                            .text,
                                  )),
                        );
                      }
