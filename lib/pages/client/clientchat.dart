                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Ini hanya demo, fitur chat dengan surveyor akan tersedia di akun asli."),
                  ...
                  GestureDetector(
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Ini hanya demo, Anda akan dapat melihat status pembayaran Anda di akun asli setelah bertransaksi."),
                          backgroundColor: Color(0xFF705D54),
                        ),
                      );
                    },
