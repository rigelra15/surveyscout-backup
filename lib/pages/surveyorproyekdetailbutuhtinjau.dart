...
class Surveyorproyekdetailbutuhtinjau extends StatefulWidget {
  final String id;

  const Surveyorproyekdetailbutuhtinjau({Key? key, required this.id})
      : super(key: key);

  @override
  _SurveyorproyekdetailbutuhtinjauState createState() =>
      _SurveyorproyekdetailbutuhtinjauState();
}

class _SurveyorproyekdetailbutuhtinjauState
    extends State<Surveyorproyekdetailbutuhtinjau> {
