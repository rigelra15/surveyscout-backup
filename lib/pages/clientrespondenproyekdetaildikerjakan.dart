...
void main() {
  runApp(Clientrespondenproyekdetaildikerjakan());
}

class Clientrespondenproyekdetaildikerjakan extends StatelessWidget {
  @override
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                                  ...
                                  children: [
                                    TextSpan(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontFamily: "NunitoSans",
                                        color: Color(0xFF705D54),
                                        fontWeight: FontWeight.bold, // Membuat "Anda" tebal
                                      ),
                                    ),
                                    TextSpan(
                                      text: ' : Silakan bergabung ke sini ya mas https://contoso.zoom.us/NFwfwqfd!03294=2',
                                      style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: "NunitoSans",
                                        color: Color(0xFF705D54),
                                        fontWeight: FontWeight.w400, // Menjaga teks lain tetap normal
                                      ),
                                    ),
                                  ],
                                ),
                ...
                SizedBox(height: 10),
                Text(
                  'Kami sedang mencari responden untuk berpartisipasi dalam survei tentang kepuasan penggunaan produk kecantikan. Responden akan diminta menjawab pertanyaan singkat terkait pengalaman mereka menggunakan produk kecantikan tertentu, merek favorit, dan preferensi pembelian. Data yang terkumpul akan digunakan untuk membantu perusahaan memahami kebutuhan konsumen dan meningkatkan kualitas produk kecantikan.',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
                ...
                SizedBox(height: 10),
                Text(
                  'Usia : 20-25 tahun Status Perkawinan : Belum Menikah Tingkat Pendidikan : S-1 Lainnya : Wanita/pria yang menggunakan produk kecantikan secara rutin (minimal 3 bulan terakhir). Bersedia meluangkan waktu 10–15 menit untuk mengisi kuesioner secara online atau wawancara singkat. Familiar dengan produk kecantikan dari merek lokal maupun internasional. ',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
                ...
                SizedBox(height: 10),
                Text(
                  'Wawancara online menggunakan Zoom yang akan disediakan oleh kami',
                  style: TextStyle(
                    fontSize: 12,
                    fontFamily: "NunitoSans",
                    color: Color(0xFFA3948D),
