...
void main() {
  runApp(Respondenproyekdetailselesai());
}

class Respondenproyekdetailselesai extends StatelessWidget {
  @override
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: 'Silakan dikerjakan di bagian tugas ya, langsung diverifikasi aja kalau udah selesai',
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w400,
                                fontFamily: "NunitoSans",
