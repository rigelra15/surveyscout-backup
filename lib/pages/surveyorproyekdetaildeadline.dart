...
void main() {
  runApp(Surveyorproyekdetaildeadline());
}

class Surveyorproyekdetaildeadline extends StatelessWidget {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color(0xFFFFCFCC), // Warna latar belakang container
                    borderRadius: BorderRadius.circular(8), // Membuat sudut melengkung
                    border: Border.all(
                      color: Color(0xFFF44336), // Warna stroke (border)
