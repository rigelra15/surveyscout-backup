...
class Surveyorproyekdetaildeadline extends StatefulWidget {
  final String id;

  const Surveyorproyekdetaildeadline({Key? key, required this.id})
      : super(key: key);

  @override
  _SurveyorproyekdetaildeadlineState createState() =>
      _SurveyorproyekdetaildeadlineState();
}

class _SurveyorproyekdetaildeadlineState
    extends State<Surveyorproyekdetaildeadline> {
