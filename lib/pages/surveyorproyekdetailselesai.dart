...
class Surveyorproyekdetailselesai extends StatefulWidget {
  final String id;

  const Surveyorproyekdetailselesai({Key? key, required this.id})
      : super(key: key);

  @override
  _SurveyorproyekdetailselesaiState createState() =>
      _SurveyorproyekdetailselesaiState();
}

class _SurveyorproyekdetailselesaiState
    extends State<Surveyorproyekdetailselesai> {
