...
class Clientsurveyorproyekdetailmenunggubayar extends StatefulWidget {
  final String id;
  final String type;
  ...
  @override
  _Clientsurveyorproyekdetailmenunggubayar createState() =>
      _Clientsurveyorproyekdetailmenunggubayar();
}

class _Clientsurveyorproyekdetailmenunggubayar
    extends State<Clientsurveyorproyekdetailmenunggubayar> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Iconify(MaterialSymbols.payments_rounded,
