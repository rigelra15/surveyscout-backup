...
void main() {
  runApp(Clientrespondenproyekdetailmerekrutdipilih());
}

class Clientrespondenproyekdetailmerekrutdipilih extends StatelessWidget {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        'Terpilih 1 dari 3, silakan pilih 2 lagi',
                        style: TextStyle(
                          fontSize: 12,
                          fontFamily: "NunitoSans",
                          color: Color(0xFFF1E9E5),
