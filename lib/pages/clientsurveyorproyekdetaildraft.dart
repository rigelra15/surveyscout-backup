...
class Clientsurveyorproyekdetaildraft extends StatefulWidget {
  final String id;
  final String type;
  ...
  @override
  _Clientsurveyorproyekdetaildraft createState() =>
      _Clientsurveyorproyekdetaildraft();
}

class _Clientsurveyorproyekdetaildraft
    extends State<Clientsurveyorproyekdetaildraft> {
