...
class SurveyorprojectCard extends StatelessWidget {
  ...
  Iconify getIconByStatus(String status) {
    switch (status) {
      case 'mendaftar':
        return const Iconify(Ic.outline_work, color: Colors.white, size: 16);
      case 'deadline':
        return const Iconify(Humbleicons.exclamation,
            color: Colors.white, size: 16);
      case 'mengerjakan':
        return const Iconify(Ic.round_work_history,
            color: Colors.white, size: 16);
      case 'ditinjau':
